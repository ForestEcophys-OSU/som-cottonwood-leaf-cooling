...
#SBATCH -J garisom_sensitivity-analysis_nrv_leaf-energy
#SBATCH -c 32
#SBATCH --mem=128G
...
run="leaf-energy"
pop="nrv"
PARAMS="../../montecarlo/output/nrv/leaftemp/20250728_140103/config.json"
...
python sa.py -i sa_problems/${pop}/${EXP}.json -o ${EXP_DIR}/${EXP}/ -m $WORKDIR -p $PARAMS -pd ../../DBG -v 2>&1 >> $EXP_OUT
